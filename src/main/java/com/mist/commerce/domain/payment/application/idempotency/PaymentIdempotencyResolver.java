...
public class PaymentIdempotencyResolver implements IdempotencyRequestResolver {

    private final ObjectMapper objectMapper;
    private final PaymentFingerprintGenerator fingerprintGenerator;

    @Override
    public boolean supports(HttpServletRequest request) {
        return "POST".equals(request.getMethod())
                && "/api/v1/payments/pay".equals(request.getRequestURI());
    }
